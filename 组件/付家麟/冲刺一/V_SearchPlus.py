...
class V_SearchPlus():
    ...
    def showBookInformation(self):
        ...
        searchResults.geometry('714x460')
        ...
        columns = ("书名", "作者", "销量", "价格", "出版时间", "出版社", "所在书架")
        ...
        tv.column("出版时间", width=80, anchor='center')
        ...
        for i in self.bookList:
            tv.insert('', k, values=(i[0], i[3], i[5], i[1], i[4], i[2], i[6]))
            k = k + 1

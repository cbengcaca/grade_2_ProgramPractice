...
class TcpHoster(threading.Thread):
    ...
    def run(self):
        ...
        while self.flag is not False:
            ...
            print(recKeyWords)
            #searchRec = M_DBOperation(recKeyWords)

            list = [
                "1bookName,bookPrice,bookCreateTime,bookAuthor,bookPublisher,bookSaleNumber,shelfLocate",
                "2bookName,bookPrice,bookCreateTime,bookAuthor,bookPublisher,bookSaleNumber,shelfLocate",
                "3bookName,bookPrice,bookCreateTime,bookAuthor,bookPublisher,bookSaleNumber,shelfLocate",
                "4bookName,bookPrice,bookCreateTime,bookAuthor,bookPublisher,bookSaleNumber,shelfLocate"
            ]
            ...
            #    cs.sendall(bytes(singleLineChangeToStr,'utr-8'))
            #cs.sendall(bytes('==', 'utf-8'))
            cs.close()
